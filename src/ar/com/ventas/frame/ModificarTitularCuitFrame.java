...
//        }
    ...
    private void llenarCampos() {
        ...
        calleTxt.setText(titular.getCalleNumero());
        localidadTxt.setText(titular.getCodigoPostalLocalidad());
        provinciaTxt.setText(titular.getProvincia());
...
//            System.out.println(ca.getDetalle());
//            System.out.println(cate);
//            System.out.println(" ");
            String codi = ca.getCodigo();
            counI += 1;
            if(codi.equals(cate)){
                rowI = counI;
            }
...
//        observacionesTxt.setText("");
    ...
    private void guardar() {
        if (validar()) {
            ...
            String categoria = categorias.get(rowL -1).getCodigo();
            titular.setCategoria(categoria);
            titular.setCuit(cuitTxt.getText());
            Date fecha1 = new Date();
            try {
                fecha1 = sdf.parse(fechaInicioActividadesTxt.getText());
            } catch (ParseException ex) {
                Logger.getLogger(ModificarTitularCuitFrame.class
            ...
            try {
                new TitularCuitService().updateTitular(titular);
            } catch (Exception ex) {
                Logger.getLogger(ModificarTitularCuitFrame.class
                        .getName()).log(Level.SEVERE, null, ex);
