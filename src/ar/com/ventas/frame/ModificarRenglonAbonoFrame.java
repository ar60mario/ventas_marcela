...
public class ModificarRenglonAbonoFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tablaRenglonAbono.getColumnModel().getColumnCount() > 0) {
            tablaRenglonAbono.getColumnModel().getColumn(0).setPreferredWidth(400);
    ...
    private void llenarCampos() {
        Direccion dm = abono.getCliente().getDireccion();
        abonoTxt.setText(dm.getCalle()+" "+dm.getNumero()+" "+abono.getRubro().getDetalle());
        renglones = null;
        try {
