...
public class VerFacturasFrame extends javax.swing.JFrame {
    ...
    public VerFacturasFrame() {
        ...
        leyenda2Txt.setText("IMPRESION EXPENSAS Y RECIBOS DE PAGO EN BCO Y "
                + "PAGOMISCTAS CON IDENT.DEPOSITO DIRECTO A CUENTA BCO X CPE, "
                + "CODIGO DE PAGO ELECTRONICO CUMPLIENDO CON ESTAND.DE CODIGO "
                + "BARRAS. SE INCLUYE DISTRIBUCION LIQUIDACION EXPENSAS Y REC.");
        llenarCombo();
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(comboR, javax.swing.GroupLayout.PREFERRED_SIZE, 310, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(54, 54, 54)
    ...
    private void llenarTabla() {
        ...
        try {
            facturas = new FacturaService().getFacturasEntreFechasAndRubro(fd, fa, ru);
        } catch (Exception ex) {
            Logger.getLogger(VerFacturasFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//            String leyenda = leyendaTxt.getText();
            ...
            for (int i = 0; i < rows; i++) {
                ...
                hoja1.addCell(new jxl.write.Number(3, y, facturas.get(i).getImporte()));
                y += 1;
            }
    ...
    private void libroVentas() {
        ...
        WritableSheet hoja1 = libro.createSheet("Listado Facturas", 0);
        try {
            hoja1.addCell(new jxl.write.Label(0, 0, "MARCELA LOUSTAU"));
    ...
    private void llenarCombo() {
        ...
        try {
            ...
            Logger.getLogger(VerFacturasFrame.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, "ERROR Nro. 495");
            return;
        }
        if (renglones != null && !renglones.isEmpty()) {
            for (RenglonFacturaParaExcel re : renglones) {
                comboR.addItem(re.getTextoCorto());
            }
        }
    }
