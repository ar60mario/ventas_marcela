 ...
 * @author Mario
 */
public class AbmCertificadosAfipFrame extends javax.swing.JFrame {
     ...
     */
    public AbmCertificadosAfipFrame() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbmCertificadosAfipFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbmCertificadosAfipFrame().setVisible(true);
            }
        });
    }
    ...
    private void llenarTabla() {
        ...
        try {
            ...
            Logger.getLogger(AbmCertificadosAfipFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
//        System.out.println(titulares.get(0).getFechaInicioActividades());
//        System.exit(0);
