...
public class VincularCertificadosFrame extends javax.swing.JFrame {
    ...
    private void llenarCampos() {
        titularTxt.setText(titular.getRazonSocial());
    ...
    private void aplicar() {
        if (validar()) {
            CertificadosAfip ca2 = null;
            try {
                ca2 = new CertificadosAfipService().getCertificadoByTitular(titular);
            } catch (Exception ex) {
            ...
            if (ca2 == null) {
                ...
                ca2.setCertificado(certificado);
                ca2.setLlave(llave);
                ca2.setTitularCuit(titular);
                ca2.setFecha(new Date());
                try {
                    new CertificadosAfipService().updateCertificado(ca2);
                    JOptionPane.showMessageDialog(this, "CERTIFICADO GUARDADO CORRECTAMENTE");
                } catch (Exception ex) {
                    Logger.getLogger(VincularCertificadosFrame.class.getName()).log(Level.SEVERE, null, ex);
                    JOptionPane.showMessageDialog(this, "ERRORGUARDANDO CERTIFICADO");
