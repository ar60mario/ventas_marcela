...
public class GenerarNcFrame extends javax.swing.JFrame {
    ...
    private String userdir = "c:/abonos/crt";
...
//                    if (cli.getAbono() != null) {
                    ...
                    try {
                        ...
                        String pto_vta = "4"; // Sucursal declarada WS
                        sucursalFacturaPapel = "0004";
...
//                                }
                        ...
                        String concepto = "3";// producto - servicio
                        ...
                        String fecha_cbte = fechaWs, fecha_venc_pago = fechaWs;
                        String fecha_serv_desde = fechaWs, fecha_serv_hasta = fechaWs;
...
//                            if (false) { // solo nc/nd 
                        ...
                        if (!resultado.equals("A")) {
                            JOptionPane.showMessageDialog(this, resultado + " Obs: " + obs + "\nError: " + errmsg
                            + " " + excepcion);
                            return;
                        }
                        if (vto != "" && vto != null) {
                        ...
                        numCae = cae.toString();
                        String ruta1 = "c:/ventasL/cmprbt/" + tipoComprob
                                + letraFacturaPapel + sucursalFacturaPapel
                                + numeroFacturaPapel + ".xm1";
                        String ruta2 = "c:/ventasL/cmprbt/" + tipoComprob
                                + letraFacturaPapel + sucursalFacturaPapel
...
//                    }
    ...
    private void solicitarNuevoTicket() {
        ...
        tkt.setToken(token);
        tkt.setSign(sign);
        System.out.println(userdir + "/marcela_2022_1c92087b2b30df1b.crt");
        System.out.println(userdir + "/clave_privada_27146186624_202208271940.key");
