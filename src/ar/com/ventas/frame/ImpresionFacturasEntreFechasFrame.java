...
//        List<Abono> ab;
//        ab = new AbonoService().getAbonosActivosPorCliente(cli);
...
//        System.out.println(rf);
    ...
    private void gpdf(Factura iv, List<RenglonFactura> rf) {
        try {
            ...
            Logger.getLogger(ImpresionFacturasEntreFechasFrame.class.getName()).log(Level.SEVERE, null, ex);
            System.out.println("ERROR 755");
        } catch (DocumentException ex) {
            Logger.getLogger(ImpresionFacturasEntreFechasFrame.class.getName()).log(Level.SEVERE, null, ex);
            System.out.println("ERROR 756");
        } catch (Exception ex) {
            Logger.getLogger(ImpresionFacturasEntreFechasFrame.class.getName()).log(Level.SEVERE, null, ex);
            System.out.println("ERROR 757");
        }
    }
    ...
    private void pdf1() {
        ...
        try {
            ...
            Logger.getLogger(ImpresionFacturasEntreFechasFrame.class.getName()).log(Level.SEVERE, null, ex);
            System.out.println("ERROR CARGANDO LINEAS DE FACTURA");
        }
        if (rf != null && !rf.isEmpty()) {
            gpdf(iv, rf);
        }
