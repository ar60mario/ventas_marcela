...
import ar.com.ventas.frame.AbmCertificadosAfipFrame;
...
import ar.com.ventas.frame.AbmTitularCuitFrame;
...
import ar.com.ventas.frame.TextosPredefinidosAbmFrame;
import ar.com.ventas.frame.VerFacturasCompletoFrame;
import ar.com.ventas.frame.VerFacturasFrame;
import ar.com.ventas.frame.VersionPyAfipWsFrame;
...
//        setExtendedState(6); // this.MAXIMIZED_BOTH
        importarClientesMnu.setVisible(false);
        crearTablasMnu.setVisible(false);
        facturasMnu.setVisible(false);
        codeBtn.setVisible(false);
        abmTextoAbonosMnu.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        textosPredefinidosMnu = new javax.swing.JMenuItem();
        rubrosMnu = new javax.swing.JMenuItem();
        certificadosMnu = new javax.swing.JMenuItem();
        titularCuitMnu = new javax.swing.JMenuItem();
        renglonesExcelMnu = new javax.swing.JMenuItem();
        ...
        verFacturasCompletoMnu = new javax.swing.JMenuItem();
        jMenu6 = new javax.swing.JMenu();
        versionMnu = new javax.swing.JMenuItem();
        versionPyafipMnu = new javax.swing.JMenuItem();

        setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);
        setTitle("FACTURACION ABONOS - MARCELA LOUSTAU");
        ...
        abmTextoAbonosMnu.setText("Renglón Rubros");
        ...
        textosPredefinidosMnu.setText("Textos Predefinidos");
        textosPredefinidosMnu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textosPredefinidosMnuActionPerformed(evt);
            }
        });
        jMenu3.add(textosPredefinidosMnu);
        ...
        jMenu3.add(certificadosMnu);

        titularCuitMnu.setText("Titular de CUIT");
        titularCuitMnu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                titularCuitMnuActionPerformed(evt);
            }
        });
        jMenu3.add(titularCuitMnu);

        renglonesExcelMnu.setText("Renglon Factura Para Excel");
        renglonesExcelMnu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                renglonesExcelMnuActionPerformed(evt);
            }
        });
        jMenu3.add(renglonesExcelMnu);
        ...
        jMenu2.add(habilitarPeriodoMnu);
        ...
        verFacturasCompletoMnu.setText("Ver Facturas completo");
        verFacturasCompletoMnu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                verFacturasCompletoMnuActionPerformed(evt);
            }
        });
        jMenu5.add(verFacturasCompletoMnu);

        jMenuBar1.add(jMenu5);

        jMenu6.setText("?");

        versionMnu.setText("Version Programa");
        ...
        versionPyafipMnu.setText("Version Conexion Afip");
        versionPyafipMnu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                versionPyafipMnuActionPerformed(evt);
            }
        });
        jMenu6.add(versionPyafipMnu);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(codeBtn, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
    ...
    private void textosPredefinidosMnuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textosPredefinidosMnuActionPerformed
        textosPredefinidos();
    }//GEN-LAST:event_textosPredefinidosMnuActionPerformed
    ...
    private void titularCuitMnuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_titularCuitMnuActionPerformed
        abmTitularCuit();
    }//GEN-LAST:event_titularCuitMnuActionPerformed

    private void versionPyafipMnuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_versionPyafipMnuActionPerformed
        versionPyafip();
    }//GEN-LAST:event_versionPyafipMnuActionPerformed

    private void verFacturasCompletoMnuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verFacturasCompletoMnuActionPerformed
        verFcCompleto();
    }//GEN-LAST:event_verFacturasCompletoMnuActionPerformed

    private void renglonesExcelMnuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_renglonesExcelMnuActionPerformed
        renglonesExcel();
    }//GEN-LAST:event_renglonesExcelMnuActionPerformed
    ...
    private javax.swing.JMenuItem renglonesExcelMnu;
    private javax.swing.JMenuItem rubrosMnu;
    private javax.swing.JButton salirBtn;
    private javax.swing.JMenuItem textosPredefinidosMnu;
    private javax.swing.JMenuItem titularCuitMnu;
    private javax.swing.JMenuItem verFacturasCompletoMnu;
    private javax.swing.JMenuItem verFacturasMnu;
    private javax.swing.JMenuItem versionMnu;
    private javax.swing.JMenuItem versionPyafipMnu;
...
//        String codigo = "";
    ...
    private void abmRenglonesRubros() {
    ...
    private void certificados() {
        AbmCertificadosAfipFrame acaf = new AbmCertificadosAfipFrame();
        acaf.setVisible(true);
        this.dispose();
    }

    private void abmTitularCuit() {
        AbmTitularCuitFrame atcf = new AbmTitularCuitFrame();
        atcf.setVisible(true);
        this.dispose();
    }

    private void versionPyafip() {
        VersionPyAfipWsFrame vpawf = new VersionPyAfipWsFrame();
        vpawf.setVisible(true);
        this.dispose();
    }

    private void testAfip() {
        TestAfipFrame taf = new TestAfipFrame();
        taf.setVisible(true);
        this.dispose();
    }

    private void verFcCompleto() {
        VerFacturasCompletoFrame vfcf = new VerFacturasCompletoFrame();
        vfcf.setVisible(true);
        this.dispose();
    }

    private void renglonesExcel() {
