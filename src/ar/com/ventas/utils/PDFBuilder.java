...
public class PDFBuilder {
    ...
    private static final String ruta = "c:/ventasL/qr/codigoQR";
    ...
    private String cuit_qr = "20146186624";
    private String puntoVenta_qr = "4";
    ...
    public File armarFacturaC(Factura iv, List<RenglonFactura> rf) throws FileNotFoundException, DocumentException, Exception {
        ...
        encabezad0 = "SERVICIO DE IMPRESION COPIADO DATA ENTRY";
        ...
        File carp = new File("c:/ventasL/data/facturas_pdf/" + carpeta);
        if (!carp.exists()) {
            carp.mkdirs();
        }

        FileOutputStream ficheroPdf = new FileOutputStream("c:/ventasL/data/facturas_pdf/" + carpeta
        ...
        float[] anchosX = new float[3];
        anchosX[0] = 45;
        anchosX[1] = 10;
        anchosX[2] = 45;
        encabezado.setWidths(anchosX);

        PdfPCell celdaEncabezado1 = new PdfPCell(new Paragraph(encabezad0, FontFactory.getFont("arial", 12, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado2 = new PdfPCell(new Paragraph("C", FontFactory.getFont("arial", 14, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado3 = new PdfPCell(new Paragraph("FACTURA", FontFactory.getFont("arial", 9, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado4 = new PdfPCell(new Paragraph("Razón Social: Marcela Estela Loustau", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        ...
        PdfPCell celdaEncabezado7 = new PdfPCell(new Paragraph("Dirección: Yatay 12 piso 7.B", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        ...
        PdfPCell celdaEncabezado10 = new PdfPCell(new Paragraph("Ciudad de Buenos Aires", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado11 = new PdfPCell(new Paragraph(" ", FontFactory.getFont("arial", 8, Font.PLAIN, NEGRO)));

        PdfPCell celdaEncabezado12 = new PdfPCell(new Paragraph("C.U.I.T.: 27-14618662-4", FontFactory.getFont("arial", 8, Font.PLAIN, NEGRO)));

        PdfPCell celdaEncabezado13 = new PdfPCell(new Paragraph("CAPITAL FEDERAL", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado14 = new PdfPCell(new Paragraph(" ", FontFactory.getFont("arial", 8, Font.PLAIN, NEGRO)));
        PdfPCell celdaEncabezado15 = new PdfPCell(new Paragraph("IIBB.: 27-14618662-4", FontFactory.getFont("arial", 8, Font.PLAIN, NEGRO)));
        ...
        PdfPCell celdaEncabezado18 = new PdfPCell(new Paragraph("Inicio Actividad: 01/07/2019", FontFactory.getFont("arial", 8, Font.PLAIN, NEGRO)));
        ...
        encabezado.addCell(celdaEncabezado1).setBorder(5);
        encabezado.addCell(celdaEncabezado2).setBorder(15);
        encabezado.addCell(celdaEncabezado3).setBorder(9);
        encabezado.addCell(celdaEncabezado4).setBorder(4);
        encabezado.addCell(celdaEncabezado5).setBorder(14);
        encabezado.addCell(celdaEncabezado6).setBorder(8);
        encabezado.addCell(celdaEncabezado7).setBorder(4);
        encabezado.addCell(celdaEncabezado8).setBorder(PdfPCell.NO_BORDER);
        encabezado.addCell(celdaEncabezado9).setBorder(8);
        encabezado.addCell(celdaEncabezado10).setBorder(4);
        encabezado.addCell(celdaEncabezado11).setBorder(PdfPCell.NO_BORDER);
        encabezado.addCell(celdaEncabezado12).setBorder(8);
        encabezado.addCell(celdaEncabezado13).setBorder(4);
        encabezado.addCell(celdaEncabezado14).setBorder(PdfPCell.NO_BORDER);
        encabezado.addCell(celdaEncabezado15).setBorder(8);
        encabezado.addCell(celdaEncabezado16).setBorder(6);
        encabezado.addCell(celdaEncabezado17).setBorder(2);
        encabezado.addCell(celdaEncabezado18).setBorder(10);
...
//        System.exit(0);
        ...
        client.addCell(celdaClient1).setBorder(13);
        client.addCell(celdaClient2).setBorder(9);
        client.addCell(celdaClient3).setBorder(12);
        client.addCell(celdaClient4).setBorder(8);
        client.addCell(celdaClient5).setBorder(14);
        client.addCell(celdaClient6).setBorder(10);
        pdf.add(client);
...
//        }
        ...
        tablaDetalle.addCell(celdaTitulos1).setBorder(15);
        tablaDetalle.addCell(celdaTitulos2).setBorder(3);
        tablaDetalle.addCell(celdaTitulos3).setBorder(3);
        tablaDetalle.addCell(celdaTitulos4).setBorder(3);
        tablaDetalle.addCell(celdaTitulos5).setBorder(15);
...
// re.getCantidad());
            ...
            if (coun == 1) {
                tablaProd.addCell(tablaProd1).setBorder(13);
                tablaProd.addCell(tablaProd2).setBorder(1);
                tablaProd.addCell(tablaProd3).setBorder(1);
                tablaProd.addCell(tablaProd4).setBorder(1);
                tablaProd.addCell(tablaProd5).setBorder(13);
            } else {
                tablaProd.addCell(tablaProd1).setBorder(12);
                ...
                tablaProd.addCell(tablaProd5).setBorder(12);
            }
...
//            String nro_lin = String.valueOf(i + coun);
            ...
            if (i == 40 - coun) {
                tablaProd.addCell(tP1).setBorder(14);
                tablaProd.addCell(tP2).setBorder(2);
                tablaProd.addCell(tP3).setBorder(2);
                tablaProd.addCell(tP4).setBorder(2);
                tablaProd.addCell(tP5).setBorder(14);
            } else {
                tablaProd.addCell(tP1).setBorder(12);
                ...
                tablaProd.addCell(tP5).setBorder(12);
            }
...
//        }
        ...
        PdfPCell pieFc5 = new PdfPCell(new Paragraph("CAE nro.:  " + cae_nro, FontFactory.getFont("arial", 12, Font.PLAIN, NEGRO)));

        com.itextpdf.text.Font font = FontFactory.getFont("C:/ventasL/ttf/PF_I2OF5_TXT.ttf",
                BaseFont.IDENTITY_H, BaseFont.EMBEDDED, 0.9f, com.itextpdf.text.Font.NORMAL, BaseColor.BLACK);
        ...
        pieFc.addCell(pieFc1).setBorder(15);
        pieFc.addCell(pieFc2).setBorder(11);
        pieFc.addCell(pieFc3).setBorder(14);
        pieFc.addCell(pieFc4).setBorder(10);
        pieFc.addCell(pieFc5).setBorder(14);
        pieFc.addCell(pieFc6).setBorder(8);
        pdf.add(pieFc);

        Image imagen = Image.getInstance("c:/ventasL/qr/CodigoQR" + nr0 + ".png");
        Image img2 = Image.getInstance("c:/ventasL/qr/afip.png");
